...
Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,584 | 🐛 21 | 🌐 Python | 📅 2026-09-23.
...
* [Official repository](https://github.com/beefytech/Beef) ⭐ 2,857 | 🐛 258 | 🌐 C++ | 📅 2026-09-22 - Repository hosting the language and its associated IDE.
...
* [CowieCLI](https://github.com/RogueMacro/CowieCLI) ⭐ 5 | 🐛 0 | 🌐 HyPhy | 📅 2020-09-05 - Awesome command line arguments parsing library.

## Coroutines

*Libraries related to coroutines and multithread programming*

* [Minicoro-beef](https://github.com/jazzbre/minicoro-beef) ⭐ 6 | 🐛 0 | 🌐 Beef | 📅 2025-03-20 - Wrapper for the C asymetric coroutines library.
...
* [Strawberry](https://github.com/MattThorson/Strawberry) ⭐ 107 | 🐛 3 | 🌐 Beef | 📅 2021-12-29 - A 2D game engine using SDL, focused on usability and simplicity.
...
* [Raylib-beef](https://github.com/Starpelly/raylib-beef) ⭐ 25 | 🐛 1 | 🌐 Beef | 📅 2026-06-02 - Autogenerated raylib bindings for the newest version of raylib.

### Libraries

* [SoLoud-beef](https://github.com/jarikomppa/soloud) ⭐ 2,177 | 🐛 123 | 🌐 C | 📅 2024-08-13 - easy to use, free, portable c/c++ audio engine for games.
...
* [BGFX-beef](https://github.com/jazzbre/bgfx-beef) ⭐ 12 | 🐛 0 | 🌐 Beef | 📅 2025-08-17 - A Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
  * Also linked in the official [BGFX repository](https://github.com/bkaradzic/bgfx/tree/master/bindings/bf) ⭐ 17,498 | 🐛 285 | 🌐 C++ | 📅 2026-09-19.
...
* [sokol-beef](https://github.com/kochol/sokol-beef) ⭐ 6 | 🐛 0 | 🌐 C | 📅 2022-07-01 - Auto generated library for [sokol](https://github.com/floooh/sokol) ⭐ 10,309 | 🐛 132 | 🌐 C | 📅 2026-09-23 headers.
...
* [Dxc-Beef](https://github.com/jayrulez/Dxc-Beef) ⭐ 3 | 🐛 0 | 🌐 Beef | 📅 2026-03-25 - [DirectXShaderCompiler](https://github.com/microsoft/DirectXShaderCompiler) ⭐ 3,653 | 🐛 767 | 🌐 C++ | 📅 2026-09-23 bindings
...
* [Shaderc-beef](https://github.com/MineGame159/shaderc-beef) ⭐ 1 | 🐛 0 | 🌐 Beef | 📅 2023-01-12 - A Beef wrapper library for [Shaderc](https://github.com/google/shaderc) ⭐ 2,186 | 🐛 169 | 🌐 C++ | 📅 2026-09-14.
...
* [Beef.Linq](https://github.com/disarray2077/Beef.Linq) ⭐ 11 | 🐛 0 | 🌐 Beef | 📅 2025-12-30 - An awesome Beef library to mimic .NETs linq, but better and faster.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/Jonathan-Racaud/awesome-beef/blob/master/CONTRIBUTING.md) ⭐ 269 | 🐛 0 | 📅 2026-07-20 first.

I will keep some pull requests open if I'm not sure whether those libraries are awesome, you could [vote for them](https://github.com/Jonathan-Racaud/awesome-beef/pulls) ⭐ 269 | 🐛 0 | 📅 2026-07-20 by adding :+1: to them. Pull requests will be merged when their votes reach **20**.
